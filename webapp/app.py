...
st.set_page_config(page_title='ALGOSTATS I-HR')
...
try:
    ...
    if rad == 'About ALGOSTATS I-HR':
        st.title("Welcome to ALGOSTATS I-HR! :nerd_face:")
        st.markdown("""Are you ready to transform the way you find the best talent for your team? Introducing ALGOSTATS I-HR, a revolution in the candidate selection process!""")
        st.subheader("""What is ALGOSTATS I-HR?""")
        st.markdown("""ALGOSTATS I-HR is a powerful and innovative PDF resume analysis tool designed to simplify and streamline the candidate screening process. With cutting-edge artificial intelligence and an intuitive interface, ALGOSTATS I-HR lets you identify ideal candidates efficiently and accurately.""")
        st.markdown("""Explore in the following items and discovery how ALGOSTATS I-HR can help you! :star-struck:""")
    ...
    if rad == "Analysis":
        st.markdown("""Below, choose a job description and a curriculum file,
                    respectively, to see how ALGOSTATS I-HR works.
                    """)
    ...
    if rad == "Creator":
        st.title("Creator: Bethanasamy Rajamani")
        st.markdown("""Hi! I'm Bethanasamy Rajamani, a Data Scientist. I'm a passionate about technology and I love to create new things.""") 
        ...
        st.markdown("""If you want to know more about me, please visit my [LinkedIn](https://www.linkedin.com/in/bethanasamy-rajamani-pmp®-aa265420/).""")
    ...
    st.error(
        ...
        application. Contact me (bethana1986@gmail.com) if the error
        persists"""
        )
